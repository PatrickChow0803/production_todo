...
import 'package:product_to_do/models/todo.dart';
import 'package:product_to_do/services/auth.dart';
import 'package:product_to_do/services/database.dart';
import 'package:product_to_do/widgets/todo_card.dart';
                      ...
                      if (_todoController.text != "") {
                        setState(() {
                          Database(firestore: widget.firestore).addTodo(
                              uid: widget.auth.currentUser.uid, content: _todoController.text);
